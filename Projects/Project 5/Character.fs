...
module CharacterDispatcher =
    ...
    type CharacterDispatcher () =
        inherit Entity3dDispatcher<CharacterModel, CharacterMessage, CharacterCommand> (true, false, false, CharacterModel.initial)

        static let [<Literal>] WalkForce = 3.5f
        static let [<Literal>] TurnForce = 8.0f
        static let [<Literal>] JumpForce = 4.0f
        ...
        override this.Command (_, command, entity, world) =
            ...
            | PostUpdate ->
                ...
                let world = World.setEye3dCenter (position + v3Up * 1.45f - rotation.Forward * 1.0f + rotation.Right * 0.35f) world
                just world
