        ...
        | AttackCharacter entity ->
            ...
            let (signals, character) =
                if character.HitPoints > 0 then
                    ...
                    | _ ->
                        let character = { character with ActionState = InjuryState { InjuryTime = world.ClockTime }}
                    ...
                    | _ ->
                        let character = { character with ActionState = WoundState { WoundTime = world.ClockTime }}
                        World.playSound Constants.Audio.SoundVolumeDefault Assets.Gameplay.InjureSound world
                        just character
