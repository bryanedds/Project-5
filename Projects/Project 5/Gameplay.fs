        ...
        if screen.GetSelected world then
            ...
            let world =
                if world.Advancing then
                    ...
                    let world = World.setEye3dCenter (position + v3Up * Constants.Gameplay.PlayerEyeLevel - rotation.Forward * 1.5333f * eyeDistanceScalar + rotation.Right * 0.4f * eyeDistanceScalar) world
