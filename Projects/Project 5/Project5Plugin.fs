...
type Project5Plugin () =
    ...
    override this.EditModes =
        Map.ofList
            [("Splash", fun world -> Game.SetProject5 Splash world)
             ("Title", fun world -> Game.SetProject5 Title world)
             ("Credits", fun world -> Game.SetProject5 Credits world)
             ("Gameplay", fun world ->
                let world = Simulants.Gameplay.SetGameplay Gameplay.initial world
                let world = Game.SetProject5 Gameplay world
                world)]
